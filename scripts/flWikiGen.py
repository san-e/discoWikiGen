...
startTime = time()
data = {"README" : f"This file was automatically generated by {path.basename(__file__)}. Do not edit unless you know what you're doing!", "Version": version,
        "Ships" : get_ships(definitions = tech.get_definitions()), "Systems" : get_systems(), "Bases" : get_bases()}
